...
const ResgistorScreen = prop => {
    const [name, setName] = useState()
    const [pass, setPass] = useState()
    const [fisrtname, setFisrt] = useState()
    const [lastname, setLasrt] = useState()
    ...
    var linkPostUser = 'https://5e032d0763d08b0014a28d2b.mockapi.io/test7/user'
    ...
    return (
        <View style={{ justifyContent: 'center', alignItems: 'center', flex: 1 }}>
            ...
            <TextInput
                style={styles.input}
                placeholder='Enter yor username' onChangeText={(tx) => { setName(tx) }}></TextInput>
            <TextInput
                style={styles.input}
            ...
            <TextInput
                ...
                onChangeText={(tx) => { setFisrt(tx) }}>
            </TextInput>
            <TextInput
                style={styles.input}
                placeholder='Enter your last name'
                onChangeText={(tx) => { setLasrt(tx) }}>
            </TextInput>
            <TouchableOpacity onPress={() => { resGistor(name, pass) }}
                style={styles.button} >
...
export default ResgistorScreen